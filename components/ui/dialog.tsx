  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-brand-surface border border-brand-border rounded-lg shadow-2xl p-6',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn('font-heading text-xl font-700 uppercase tracking-wide text-brand-cream', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn('text-sm text-brand-secondary', className)} {...props} />
))
