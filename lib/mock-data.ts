...
export const SHOP_NAME = 'Janzen Ag and Auto'
...
export const MECHANICS = [
  ...
  { id: 'layton', name: 'Layton', role: 'Lead Technician',     years: 9,  specialty: 'Electrical & Diagnostics', initials: 'L' },
  { id: 'matt',   name: 'Matt',   role: 'Technician',          years: 6,  specialty: 'Tires & Brakes',          initials: 'M' },
  { id: 'tyler',  name: 'Tyler',  role: 'Junior Technician',   years: 3,  specialty: 'Oil Service & Tune-Ups',  initials: 'T' },
]
...
export const JOBS: Job[] = [
  ...
  { id: 'j3',  customer: 'Mike Davis',      phone: '(306) 555-0334', vehicle: { year: 2022, make: 'Ram',       model: '1500'          }, service: 'Tire Install (Set of 4)',   serviceId: 'tire-install',        notes: 'Switching to winter tires. Rims already off.',                 bay: 3, mechanic: 'layton', date: '2026-04-27', time: '10:30', duration: 1.0, status: 'waiting-parts'},
  { id: 'j4',  customer: 'Emily Chen',      phone: '(306) 555-0445', vehicle: { year: 2018, make: 'Honda',     model: 'Civic'         }, service: 'Tune-Up',                   serviceId: 'tune-up',             notes: 'Check engine light on. Last tune-up 3 years ago.',             bay: 4, mechanic: 'tyler', date: '2026-04-27', time: '11:00', duration: 1.0, status: 'booked'       },
  ...
  { id: 'j7',  customer: 'James Martinez',  phone: '(306) 555-0778', vehicle: { year: 2021, make: 'Toyota',    model: 'Tundra'        }, service: 'Wheel Alignment',           serviceId: 'wheel-alignment',     notes: 'Pulling right since hitting pothole last month.',              bay: 3, mechanic: 'layton', date: '2026-04-29', time: '10:00', duration: 1.0, status: 'booked'       },
  { id: 'j8',  customer: 'Karen White',     phone: '(306) 555-0889', vehicle: { year: 2023, make: 'Kia',       model: 'Seltos'        }, service: 'Battery Replacement',       serviceId: 'battery-replacement', notes: "Won't start on cold mornings.",                                bay: 4, mechanic: 'tyler', date: '2026-04-29', time: '08:30', duration: 0.5, status: 'booked'       },
  ...
  { id: 'j11', customer: 'David Garcia',    phone: '(306) 555-1112', vehicle: { year: 2019, make: 'Nissan',    model: 'Altima'        }, service: 'Tire Rotation',             serviceId: 'tire-rotation',       notes: 'Cross-rotate. Visual inspection of tread wear.',               bay: 3, mechanic: 'layton', date: '2026-05-04', time: '11:00', duration: 0.5, status: 'booked'       },
  { id: 'j12', customer: 'Amy Taylor',      phone: '(306) 555-1223', vehicle: { year: 2022, make: 'Jeep',      model: 'Grand Cherokee' }, service: 'Brake Job (Pads + Rotors)', serviceId: 'brake-job',          notes: 'Squealing at low speed. Full 4-corner inspection.',            bay: 4, mechanic: 'tyler', date: '2026-05-04', time: '08:30', duration: 1.5, status: 'booked'       },
]
...
export const OUTREACH_DRAFTS: Record<string, string> = {
  pc1: "Hi Alice! 👋 It's been about 6 months since your last oil change at Janzen Ag and Auto. Time for your next one! Give us a call at (306) 555-0182 or reply BOOK to schedule. We'll have you back on the road fast. – The J&A Team",
  pc2: "Hi Robert! We noticed it's been 8 months since your brake service at Janzen Ag and Auto. Winter road conditions can be tough on brakes — let us take a look. Call (306) 555-0182 or reply BOOK to book a free brake inspection. – The J&A Team",
  pc3: "Hey Jessica! Your Honda Pilot is due for another tire rotation — it's been about 5 months. Keep that tread wearing evenly! Book online or call us at (306) 555-0182. – Janzen Ag and Auto",
  pc4: "Hi Chris! It's been 7 months since your tune-up at J&A Auto. How's the 4Runner running? If you're noticing any roughness or hesitation, we'd love to take a look. Call (306) 555-0182 anytime. – The J&A Team",
  pc5: "Hi Melissa! We wanted to follow up — it's been 6 months since your diagnostic visit. If any warning lights have come back or you're experiencing new issues, bring the Equinox by. We're here Mon–Sat. – Janzen Ag and Auto",
  pc6: "Hey Daniel! Your Forester is coming up on another oil change interval. Full synthetic keeps that Boxer engine happy 🔧 Book your spot at (306) 555-0182. – The J&A Team",
  pc7: "Hi Jennifer! Road conditions this winter may have knocked your alignment off again. A quick check is only $89–$129 and takes about an hour. Call us at (306) 555-0182 to book. – Janzen Ag and Auto",
  pc8: "Hi Mark! It's been a full year since your fuel system service — a good time for another round to keep that Ram running strong. We have openings this week. Call (306) 555-0182 or reply BOOK. – The J&A Team",
}
...
export const AI_SUGGESTIONS = [
  ...
  {
    id: 's3',
    message: "Bay 4 has back-to-back 1.5-hour brake jobs with no buffer today. Tyler may run into overtime. Suggest moving Amy Taylor's Brake Job to tomorrow morning at 8:30 AM when Bay 4 opens fresh. Approve the reschedule?",
    type: 'reschedule',
    dismissed: false,
  },
]
...
export const KPI_DATA = {
  bays: [
    ...
    { bay: 3, mechanic: 'Layton', jobsToday: 2, billableHours: 1.5, avgDuration: 0.75, currentStatus: 'waiting-parts' as JobStatus, overTime: false },
    { bay: 4, mechanic: 'Tyler', jobsToday: 3, billableHours: 2.5, avgDuration: 0.83, currentStatus: 'booked'      as JobStatus, overTime: false },
  ],
  weeklyBillableHours: [
    { name: 'Dusty',  hours: 34 },
    { name: 'Matt',   hours: 28 },
    { name: 'Layton', hours: 31 },
    { name: 'Tyler', hours: 22 },
  ],
  shopEfficiency: 87,
}
